/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/generated/workers.d.ts --config ./wrangler.jsonc` (hash: 5258953aa2cad0c45a92f96da2f8d863)
// Runtime types generated with workerd@1.20251118.0 2025-10-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		GAME_ROOM: DurableObjectNamespace /* GameRoom from min-or-max-api */
		MATCHMAKER: DurableObjectNamespace /* Matchmaker from min-or-max-api */
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<Cloudflare.Env, 'ALLOWED_ORIGINS'>
	> {}
}
